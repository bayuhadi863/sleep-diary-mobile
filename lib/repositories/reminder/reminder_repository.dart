...
class ReminderRepository {
  ...
  Future<TimeOfDay> getReminderTime() async {
    try {
      ...
      if (reminderDoc.docs.isNotEmpty) {
        ...
        await FirebaseFirestore.instance.collection('reminders').add(ReminderModel.empty().toJson());
  ...
  Future<void> updateReminderTime(TimeOfDay time) async {
    final reminderData = await FirebaseFirestore.instance.collection('reminders')
      .where('userId', isEqualTo: FirebaseAuth.instance.currentUser!.uid)
      .get();
  ...
  Future<bool> getReminderIsActive() async {
    try {
      ...
      if (reminderDoc.docs.isNotEmpty) {
        return ReminderModel.fromJson(reminderDoc.docs.first.data()).isActiveReminder!;
      } 
      else {
